...
def render_form(values, errors, user=None, csrf=""):
...
def render_admin(users, stats, message="", csrf=""):
...
def render_admin_edit(user, errors=None, csrf=""):
    errors = errors or {}
